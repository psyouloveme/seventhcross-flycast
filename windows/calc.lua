...
function exports.build_calc_window()
    ...
    ui.button("L30 Body", function()
      ...
      print(grid.test_coords(75,7,1475,0x8c3bfb18))
      print(grid.test_coords(151,73,14751,0x8c3cca88))
      -- print(grid.run_conversions(x,y,index,offset))
      print(grid.run_conversions(75,7,1475,0x8c3bfb18))
      print(grid.run_conversions(nil,nil,17170,nil))
      print(grid.run_conversions(nil,nil,17172,nil))
      print(grid.test_coords(172,85,17172,0x8c3cf05c))
