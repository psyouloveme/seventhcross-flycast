...
---@field getDeviceType fun(bus: MapleTypes.Bus): MapleTypes.Device
---@field getSubDeviceType fun(bus: MapleTypes.Bus, port: MapleTypes.Port): MapleTypes.SubDevice
---@field setDeviceType fun(bus: MapleTypes.Bus, type: MapleTypes.Device): nil
---@field setSubDeviceType fun(bus: MapleTypes.Bus, port: MapleTypes.Port, type: MapleTypes.SubDevice): nil
...
---@class Flycast.Input
---@field getButtons fun(player: InputTypes.Player): integer
---@field pressButtons fun(player: InputTypes.Player, buttons: integer): nil
---@field releaseButtons fun(player: InputTypes.Player, buttons: integer): nil
---@field getAxis fun(player: InputTypes.Player, axis: InputTypes.ControllerAxis): integer
---@field setAxis fun(player: InputTypes.Player, axis: InputTypes.ControllerAxis, value: integer): nil
---@field getAbsCoordinates fun(player: InputTypes.Player): number, number
---@field setAbsCoordinates fun(player: InputTypes.Player, x: number, y: number): nil
---@field getRelCoordinates fun(player: InputTypes.Player): number, number
---@field setRelCoordinates fun(player: InputTypes.Player, x: number, y: number): nil
